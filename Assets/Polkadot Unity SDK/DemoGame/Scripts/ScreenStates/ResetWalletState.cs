...
{
    public class ResetWalletState: GameBaseState
    {
        private Button _btnDeleteWallet;

        public ResetWalletState(DemoGameController _flowController)
        ...
        public override void EnterState()
        {
            ...
            var visualTreeAsset = Resources.Load<VisualTreeAsset>($"DemoGame/UI/Screens/ResetScreenUI");
            ...
            var txfActionVerification = instance.Q<HexalemTextField>("TxfActionVerification");

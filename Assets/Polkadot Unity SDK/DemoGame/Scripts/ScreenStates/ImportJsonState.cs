...
{
    public class ImportJsonState: GameBaseState
    {
        private Button _btnCreateWalletJson;

        private HexalemTextField _txfJsonContent;

        public ImportJsonState(DemoGameController _flowController)
        ...
        public override void EnterState()
        {
            ...
            _txfJsonContent = instance.Q<HexalemTextField>("TxfJsonContent");

...
namespace Assets.Scripts.ScreenStates
{
    public class LoadScreenState: GameBaseState
    {
        ...
        public override void EnterState()
        {
            ...
            var visualTreeAsset = Resources.Load<VisualTreeAsset>($"DemoGame/UI/Screens/LoadingScreenUI");
